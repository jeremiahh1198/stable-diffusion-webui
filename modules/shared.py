...
sd_model_file = '../../../datasets/models/sd-model.ckpt'
...
parser.add_argument("--gfpgan-dir", type=str, help="GFPGAN directory", default='../../../datasets/models')
parser.add_argument("--gfpgan-model", type=str, help="GFPGAN model file name", default='gfpgan.pth')
